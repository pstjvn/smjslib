...
sm.template.Recover = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<div is class="' + goog.getCssName('sm-recover') + ' ' + goog.getCssName('sm-form') + '" use-pointer><div>' + soy.$$escapeHtml(pstj.templates.ErrorMsg(null, null, opt_ijData)) + '</div><div>' + soy.$$escapeHtml(pstj.material.template.Input({error: soydata.$$markUnsanitizedTextForInternalBlocks('Username is required'), label: soydata.$$markUnsanitizedTextForInternalBlocks('Username'), required: true, name: 'username', type: 'text', value: ''}, null, opt_ijData)) + '</div><div class="' + goog.getCssName('sm-form-button-container') + '">' + soy.$$escapeHtml(pstj.material.template.Button({content: soydata.$$markUnsanitizedTextForInternalBlocks('request password'), icon: 'none', ink: true, action: 'recover'}, null, opt_ijData)) + '</div><div><span class="' + goog.getCssName('pstj-linklike') + '" data-activity-switch="login">Go back to login</span></div><div is class="' + goog.getCssName('material-shadow') + ' ' + goog.getCssName('material-shadow-2') + '"><div class="' + goog.getCssName('material-shadow-bottom') + '"></div><div class="' + goog.getCssName('material-shadow-top') + '"></div></div></div>');
};
if (goog.DEBUG) {

...
smstb.widget.MobilePopup.prototype.decorateInternal = function(el) {
  ...
  this.frameOverlay_ = goog.dom.createDom('iframe', goog.getCssName(
      'smstb-iframe-overlay'));
 ...
 * @param {function(boolean):void=} opt_callback The callback to use when
 * handling the result from the popup query.
 */
smstb.widget.MobilePopup.prototype.enable = function(enable, opt_callback) {
  if (enable) {
